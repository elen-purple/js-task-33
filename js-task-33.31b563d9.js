...
input.addEventListener("input", (0, _lodashDefault.default).debounce(()=>{
    const userCountry = input.value;
    fetch("https://restcountries.com/v3.1/all").then((resolve)=>resolve.json()).then((countries)=>{
        console.log(countries[0]);
        console.log(userCountry);
        const filteredCountries = countries.filter((country)=>country.name.common.toLowerCase().includes(userCountry.toLowerCase()));
        if (filteredCountries.length > 10) setALotItems();
        else if (filteredCountries.length <= 10 && filteredCountries.length > 1) setCertanlyItems(filteredCountries);
        else if (filteredCountries.length === 1) setOnlyItem(filteredCountries);
        else if (filteredCountries.length === 0) setNoItem();
        if (userCountry === "") {
...
function setCertanlyItems(countries) {
    ...
    countries.map((country)=>country.name.common).forEach((name)=>{
        certanlyItems.insertAdjacentHTML("beforeend", `<li class="category__item">${name}</li>`);
    });
}
function setOnlyItem(contries) {
    ...
    Object.values(contry.languages).forEach((lang)=>{
        onlyItem.querySelector("#languages").insertAdjacentHTML("beforeend", `<li class="category__subitem">${lang}</li>`);
    });
}
...
},{"/node_modules/@pnotify/core/dist/PNotify.js":"fay4s","/node_modules/@pnotify/mobile/dist/PNotifyMobile.js":"5RXYV","lodash":"LUhzz","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fay4s":[function(require,module,exports,__globalThis) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
...
},{}],"LUhzz":[function(require,module,exports,__globalThis) {
var global = arguments[3];
(function() {
...
},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequiref5fc", {})

//# sourceMappingURL=js-task-33.31b563d9.js.map
